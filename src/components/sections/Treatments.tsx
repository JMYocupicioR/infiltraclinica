    ...
    <section id="tratamientos" className="bg-gradient-to-b from-white to-[#F8F5F2]">
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="flex items-end justify-between">
          ...
          <a
            href="#contacto"
            className="hidden md:inline-block text-sm px-4 py-2 rounded-2xl text-white"
        ...
        <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {cards.map((card) => (
            <a
              key={card.name}
              href={card.href}
              className="rounded-2xl border border-slate-200 p-5 bg-white shadow-sm hover:shadow-md transition"
            >
              ...
              <div className="mt-3 text-sm text-slate-600">
                Infiltraciones de precisión avanzadas. Explicación clara antes de decidir el procedimiento.
              </div>
            </a>
          ))}
        </div>
