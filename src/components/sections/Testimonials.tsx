export default function Testimonials() {
  const items = [
    {
      quote: 'Me explicaron todo con calma y el procedimiento fue rápido. A la semana ya caminaba mejor.',
      author: 'Elena, 68 años',
    },
    {
      quote: 'Valoré la precisión del procedimiento y que me explicaran cada paso del proceso.',
      author: 'Carlos, 43 años',
    },
    {
      quote: 'Trato humano y seguimiento cercano. Recomiendo la clínica.',
      author: 'Sofía, 56 años',
    },
  ];
  return (
