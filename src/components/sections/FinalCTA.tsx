  ...
  return (
    <section id="contacto" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 text-white">
        ...
        <p className="mt-2 text-white/90 max-w-2xl">Agenda una evaluación y conoce si una infiltración guiada por imagen puede ayudarte. Te explicamos el procedimiento, riesgos y alternativas.</p>
